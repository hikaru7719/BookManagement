...
public class LendReserveServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response)
		...
		int reserve_book_number = Integer.parseInt(request.getParameter("reserve_book_number"));
		...
		LendBookManager manager=new LendBookManager();
		 ...
		 manager.LendRemoveBook(reserve_book_number);
